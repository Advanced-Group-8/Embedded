...
sMQTTNewClientEvent::sMQTTNewClientEvent(sMQTTClient *client, std::string &_login, std::string &_password)
	: sMQTTEvent(NewClient_sMQTTEventType), _client(client), login(_login), password(_password) {};
...
sMQTTRemoveClientEvent::sMQTTRemoveClientEvent(sMQTTClient *client)
	: sMQTTEvent(RemoveClient_sMQTTEventType), _client(client) {};
